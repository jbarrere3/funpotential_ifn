...
```{r save-plot-compare-mortality-tree-plot-level, fig.height=6, fig.width=10, fig.align='center'}
tar_read(plot_compare_mortality_tree_plot_level)
ggplot2::ggsave(tar_read(plot_compare_mortality_tree_plot_level), 
       filename = "plots/plot_compare_mortality_tree_plot_level.pdf", 
       height = 12, width = 20, unit = 'cm')  
```
...
```{r save-plot-harvest-probability, fig.height=6, fig.width=10, fig.align='center'}
tar_read(plot_probability_to_be_harvested)
ggplot2::ggsave(tar_read(plot_probability_to_be_harvested), 
       filename = "plots/plot_probability_to_be_harvested.pdf", 
