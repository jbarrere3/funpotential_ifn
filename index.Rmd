...
And we merge these two dataframes to obtain the complete tree NFI dataset formatted for TreeMort. 

```{targets format-trees-NFI-to-TreeMort}
tar_target(TreeMort_tree, rbind(TreeMort_tree_census1, TreeMort_tree_census2))
```
