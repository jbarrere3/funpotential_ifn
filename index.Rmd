...
Parameters value: 
```{r plot-parameters-Aalba, fig.height=6, fig.width=8, fig.align='center', dpi=600}
tar_read(fig_parameters_A.alba)
```

Convergence:
```{r plot-convergence-Aalba, fig.height=6, fig.width=8, fig.align='center', dpi=600}
...
Parameters value:
```{r plot-parameters-Psylvestris, fig.height=6, fig.width=8, fig.align='center', dpi=600}
tar_read(fig_parameters_P.sylvestris)
```

Convergence:
```{r plot-convergence-Psylvestris, fig.height=6, fig.width=8, fig.align='center', dpi=600}
