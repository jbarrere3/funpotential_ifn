...
```{r plot-compare-parameters-simulated, fig.height=4, fig.width=12, fig.align='center', dpi=600}
...
Comparison of true simulated parameter value and fitted values. 
```{r plot-compare-parameters-simulated-2, fig.height=4, fig.width=12, fig.align='center', dpi=600}
