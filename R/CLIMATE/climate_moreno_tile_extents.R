...
france <- c('B_7','C_6','C_7','C_8','D_6','D_7','D_8','E_7','E_8','E_9')
#B_6 <- extent(stack(paste0(dirclimate, "france/B_6/Prcp2008_B_6.tif"))[[1]])
B_7 <- extent(stack(paste0(dirclimate, "france/B_7/Prcp2008_B_7.tif"))[[1]])
C_6 <- extent(stack(paste0(dirclimate, "france/C_6/Prcp2008_C_6.tif"))[[1]])
C_7 <- extent(stack(paste0(dirclimate, "france/C_7/Prcp2008_C_7.tif"))[[1]])
C_8 <- extent(stack(paste0(dirclimate, "france/C_8/Prcp2008_C_8.tif"))[[1]])
D_6 <- extent(stack(paste0(dirclimate, "france/D_6/Prcp2008_D_6.tif"))[[1]])
D_7 <- extent(stack(paste0(dirclimate, "france/D_7/Prcp2008_D_7.tif"))[[1]])
D_8 <- extent(stack(paste0(dirclimate, "france/D_8/Prcp2008_D_8.tif"))[[1]])
E_7 <- extent(stack(paste0(dirclimate, "france/E_7/Prcp2008_E_7.tif"))[[1]])
E_8 <- extent(stack(paste0(dirclimate, "france/E_8/Prcp2008_E_8.tif"))[[1]])
E_9 <- extent(stack(paste0(dirclimate, "france/E_9/Prcp2008_E_9.tif"))[[1]])
...
tile_extents <- rbind(cbind(B_7[1],B_7[2],B_7[3],B_7[4],"B_7"), cbind(C_6[1],C_6[2],C_6[3],C_6[4],"C_6"), 
                      cbind(C_7[1],C_7[2],C_7[3],C_7[4],"C_7"), cbind(C_8[1],C_8[2],C_8[3],C_8[4],"C_8"), 
                      cbind(D_6[1],D_6[2],D_6[3],D_6[4],"D_6"), cbind(D_7[1],D_7[2],D_7[3],D_7[4],"D_7"), 
                      cbind(D_8[1],D_8[2],D_8[3],D_8[4],"D_8"), cbind(E_7[1],E_7[2],E_7[3],E_7[4],"E_7"), 
                      cbind(E_8[1],E_8[2],E_8[3],E_8[4],"E_8"), cbind(E_9[1],E_9[2],E_9[3],E_9[4],"E_9"))
...
save(tile_extents, file=paste0(dirclimate, "climate_moreno_tile_extents.RData"))
